        ...
        try {
            ...
            const wins = await this.db.pool.query(`
                ...
                WHERE p.created_at >= NOW() - INTERVAL '24 hours'
                    ...
                    AND p.type IN ('airpods4', 'зя 5000', 'вб3000', 'зя2000', 'вб2000', 'зя1000', 'вб1000', 'зя500', 'вб500', 'зя300', 'powerbank', 'charger', 'golden-apple', 'dolce')
...
#выигрыш #удача #kosmetichka`;
    ...
    getPrizeName(prizeType) {
        const names = {
            'airpods4': 'AirPods 4',
            'зя 5000': 'Сертификат 5000₽ ЗЯ',
            'вб3000': 'Сертификат 3000₽ WB',
            'зя2000': 'Сертификат 2000₽ ЗЯ', 
            'вб2000': 'Сертификат 2000₽ WB',
            'зя1000': 'Сертификат 1000₽ ЗЯ',
            'вб1000': 'Сертификат 1000₽ WB',
            'зя500': 'Сертификат 500₽ ЗЯ',
            'вб500': 'Сертификат 500₽ WB',
            'зя300': 'Сертификат 300₽ ЗЯ',
            'powerbank': 'PowerBank',
